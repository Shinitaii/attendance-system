...
public class sectionMemberSettings extends JDialog {
	...
	public static void main(String[] args) {
		try {
			sectionMemberSettings dialog = new sectionMemberSettings();
	...
	public sectionMemberSettings() {
		...
		JLabel lblNewLabel = new JLabel("Add a student or teacher here:");
